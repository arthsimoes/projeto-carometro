O Projeto "Carômetro" foi uma atividade passada em aula, onde o objetivo era desenvolver (escrever o código) a estrutura do programa e também fazer a interface dele (front) na IDE Eclipse.
